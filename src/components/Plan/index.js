                  ...
                  return (
                    <div className="w-full p-3  justify-start">
                      ...
                      <div className="flex-1 flex flex-col justify-start">
                        <div
                          className="bg-gray-300 w-full rounded-3xl flex"
                          style={{ height: 20 }}
                          data-tooltip-id={category.id}
                        >
                          <div
                            className={`${
                              handleProgress(category).bg
                            } text-white text-center text-sm rounded-3xl`}
                            style={{
                              width: `${
                                handleProgress(category).percent > 1
