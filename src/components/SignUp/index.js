        ...
        <div className='grid grid-cols-2 h-[100vh] mx-auto max-w-[1000px]'>
            <div className='col-span-1 h-full grid place-items-center'>
                <form className='max-w-[300px] w-full'>
                    ...
                    <div className='flex flex-col items-start pb-4'>
                        <div>Tên</div>
                        <input placeholder='Ví dụ: Nguyễn Văn A' className='p-2 border-[1px] min-w-full outline-none rounded-lg border-black bg-slate-100' />
                    </div>
                    ...
                    <div className='text-sm text-center text-blue-500 w-full mt-4'>
                        <span className='text-black'>Đã có tài khoản?</span> <button onClick={() => setTab('login')} className='font-semibold text-blue-500'>Đăng nhập</button>
                    </div>
                </form>
            </div>
